...
<div id="tooplate_main">
  <p class="style62"><span class="style31 style46 style30  style35">All Purchased Products and Users.. </span></p>
  <p class="style62">&nbsp;</p>
  <div id="tooplate_sidebar">
        
            <table width="906" border="1" align="center"  cellpadding="0" cellspacing="0">
              <tr>
                <td  valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style55 style61">Id </div></td>
                ...
                <td valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style55 style61">Purchased By </div></td>
                <td valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style55 style61">Price</div></td>
                <td valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style55 style61">Purchased Date</div></td>
              </tr>
              ...
              <%
					...
					%>
                      <tr>
                        <td  width="51"  valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                          <p>
                            <%out.println(i);%>
                          </p>
                        </div></td>
                <td  width="157" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                ...
                <td  width="106" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                  <p>
                    <%out.println(title1);%>
                  </p>
                </div></td>
                <td  width="92" valign="middle" height="133" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                  <p>
                ...
                <td  width="91"  valign="middle" height="133" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                  <p>
                    <%out.println(decrypted_company12);%>
                  </p>
                </div></td>
                <td  width="76" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                  <p>
                    <%out.println(decrypted_model12);%>
                  </p>
                </div></td>
                <td  width="119"  valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                    <p class="style64"> <a href="PurchaseUserProfile.jsp?username=<%=s5%>">
                      <%out.println(s5);%>
                    </a></p>
                </div></td>
                <td  width="90" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style20 style37 style56 style63">
                  <p>
