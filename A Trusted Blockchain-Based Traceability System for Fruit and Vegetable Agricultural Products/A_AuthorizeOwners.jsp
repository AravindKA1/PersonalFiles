...
<title>Authorize Data Owners..</title> 
...
<div id="tooplate_main">
    ...
    <div id="tooplate_content">
        ...
        <h2><span class="style31 style46 style30  style35">View and Authorize Data Owners..</span></h2>
        ...
        <table width="592" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
          <tr>
            ...
            <td  width="116" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Owner Image</div></td>
            <td  width="109" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Owner Name</div></td>
          ...
          <%
						...
						try 
						{
						   	String query="select * from data_owner"; 
          ...
          <tr>
            ...
            <td width="116" rowspan="1" align="center" valign="middle" ><div class="style5 style37 style54 style55 style22" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                <input  name="image" type="image" src="owner_Pic.jsp?id=<%=i%>" style="width:90px; height:90px;" />
            </a> </div></td>
            ...
            <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center" class="style22 style5 style20 style30 style37">
                <div align="center" class="style20 style37 style46"><a href="A_OwnerStatus.jsp?id=<%=i%>" class="style32 style30">waiting</a></div>
            </div></td>
            <%
						}
						else
    ...
    <div id="tooplate_sidebar">
            ...
            <ul class="tooplate_list"><li>
              <p><a href="A_AuthorizeOwners.jsp">Home</a></p>
            </li>
              <li>
