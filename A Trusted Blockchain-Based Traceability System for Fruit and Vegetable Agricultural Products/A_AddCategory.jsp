    ...
    <div id="tooplate_header">
        ...
        <tr>
          <td width="943"><div class="style1" id="div">
            <h1 align="left" class="style2 style37"><br />
...
<div id="tooplate_main">
    ...
    <div id="tooplate_content">
        ...
        <h2><span class="style36 style35">Adding Categories..</span></h2>
                   
                  
        <form action="A_AddCategory1.jsp" method="post" enctype="multipart/form-data">
		  <p>&nbsp;</p>
		  <table width="321" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td  width="147" height="55" valign="middle" style="color: #2c83b0;"><div align="left" class="style7 style15 style18 style21 style4" style="margin-left:20px;">Categorie Name </div></td>
	      ...
	      <p align="right">&nbsp;</p>
	      <p align="right"><a href="AdminMain.jsp" class="style11"><strong>Back</strong></a></p>
		</form>
  </div>
    <div id="tooplate_sidebar">
            ...
            <ul class="tooplate_list"><li>
              <p><a href="A_AddCategory.jsp">Home</a></p>
            </li>
              <li>
