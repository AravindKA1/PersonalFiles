...
<div id="tooplate_main">
          ...
          <table width="363" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="164" height="46" align="center"><div align="left" class="style7"> </div>
                ...
                <div align="left" class="style7"><strong>User Name (required)</strong></div>
                <span class="style3">
                  </label>
              </span> </td>
    ...
    <div id="tooplate_sidebar">
      ...
      <ul class="tooplate_list">
		<li><a href="UserRe-Login.jsp">Home</a></li>
        <li>
        <a href="index.html">Index Page</a></li>
    </ul>
  </div>
