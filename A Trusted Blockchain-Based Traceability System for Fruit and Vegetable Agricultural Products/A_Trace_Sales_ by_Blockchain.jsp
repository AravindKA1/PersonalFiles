...
<div id="tooplate_main">
  <p class="style62"><span class="style31 style46 style30  style35">View All Traceed Vegetables Sales by Blockchain.. </span></p>
  <p class="style62">&nbsp;</p>
  <p class="style62">Blockchain for Vegetables sales </p>
  <p class="style62">&nbsp;</p>
  <p class="style62"><iframe width="750" height="500" src="Vegetables_Sales.jsp"></iframe></p>
  <p class="style62">&nbsp;</p>
  <p class="style62">&nbsp;</p>
  <p class="style62">Blockchain for Fruit sales </p>
  <p class="style62">&nbsp;</p>
  <p class="style62"><iframe width="750" height="500" src="Fruits_Sales.jsp"></iframe></p>
  <p class="style62">&nbsp;</p>
