...
<table width="951" border="0" cellspacing="2" cellpadding="2">
        <tr>
          <td width="943"><div class="style1" id="div">
            <h1 align="left" class="style2 style37 style41">A Trusted Blockchain-Based Traceability System for Fruit and Vegetable Agricultural Products </h1>
...
<div id="tooplate_main">
    ...
    <div id="tooplate_content">
        ...
        <h2><span class="style12"><span class="style1"><span class="style32">User</span> <span class="style23"><%=(String)application.getAttribute("uname")%><span class="style32">'s</span></span> <span class="style32">Profile</span></span><span class="style32">..</span></span></h2>
