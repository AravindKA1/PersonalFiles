...
<div id="tooplate_main">
    ...
    <div id="tooplate_content">
        ...
        <h2><span class="style12"><span class="style1"><span class="style32">Data Owner </span> <span class="style23"><%=(String)application.getAttribute("dname")%><span class="style32">'s</span></span> <span class="style32">Profile</span></span><span class="style32">..</span></span></h2>
		...
		<p>&nbsp;</p>
		<p align="right"><a href="DO_Main.jsp" class="style11">Back</a></p>
    ...
    <div id="tooplate_sidebar">
      ...
      <ul class="tooplate_list">
		<li>
		  <p><a href="DO_Profile.jsp">Home</a></p>
		</li>
        <li>
